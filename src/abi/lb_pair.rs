    ...
    pub mod functions {
        ...
        impl Burn {
            const METHOD_ID: [u8; 4] = [10u8, 205u8, 69u8, 29u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl CollectFees {
            const METHOD_ID: [u8; 4] = [34u8, 91u8, 32u8, 185u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl FeeParameters {
            const METHOD_ID: [u8; 4] = [152u8, 199u8, 173u8, 243u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for FeeParameters {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct FindFirstNonEmptyBinId {
            pub u_id: substreams::scalar::BigInt,
            pub u_swap_for_y: bool,
        }
        impl FindFirstNonEmptyBinId {
            const METHOD_ID: [u8; 4] = [143u8, 145u8, 154u8, 131u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                ...
                let mut values = ethabi::decode(
                        &[ethabi::ParamType::Uint(24usize), ethabi::ParamType::Bool],
                        maybe_data.unwrap(),
                    )
                    .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
                values.reverse();
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Bool(self.u_swap_for_y.clone()),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
        ...
        impl substreams_ethereum::Function for FindFirstNonEmptyBinId {
            const NAME: &'static str = "findFirstNonEmptyBinId";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl ForceDecay {
            const METHOD_ID: [u8; 4] = [211u8, 185u8, 251u8, 228u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl GetBin {
            const METHOD_ID: [u8; 4] = [10u8, 190u8, 150u8, 136u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl GetGlobalFees {
            const METHOD_ID: [u8; 4] = [165u8, 130u8, 205u8, 170u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetGlobalFees {
            const NAME: &'static str = "getGlobalFees";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetOracleParameters {}
        impl GetOracleParameters {
            const METHOD_ID: [u8; 4] = [85u8, 24u8, 40u8, 148u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetOracleParameters {
            const NAME: &'static str = "getOracleParameters";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetOracleSampleFrom {
            pub u_time_delta: substreams::scalar::BigInt,
        }
        impl GetOracleSampleFrom {
            const METHOD_ID: [u8; 4] = [162u8, 22u8, 53u8, 167u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_time_delta.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for GetOracleSampleFrom {
            const NAME: &'static str = "getOracleSampleFrom";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetReservesAndId {}
        impl GetReservesAndId {
            const METHOD_ID: [u8; 4] = [27u8, 5u8, 184u8, 62u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetReservesAndId {
            const NAME: &'static str = "getReservesAndId";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct IncreaseOracleLength {
            pub u_new_size: substreams::scalar::BigInt,
        }
        impl IncreaseOracleLength {
            const METHOD_ID: [u8; 4] = [199u8, 189u8, 101u8, 134u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.u_new_size.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for IncreaseOracleLength {
            const NAME: &'static str = "increaseOracleLength";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct Initialize {
            ...
            pub u_packed_fee_parameters: [u8; 32usize],
        }
        impl Initialize {
            const METHOD_ID: [u8; 4] = [211u8, 45u8, 180u8, 55u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
                ...
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::FixedBytes(
                            self.u_packed_fee_parameters.as_ref().to_vec(),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        pub struct Mint {
            pub u_ids: Vec<substreams::scalar::BigInt>,
            pub u_distribution_x: Vec<substreams::scalar::BigInt>,
            pub u_distribution_y: Vec<substreams::scalar::BigInt>,
            pub u_to: Vec<u8>,
        }
        impl Mint {
            const METHOD_ID: [u8; 4] = [113u8, 76u8, 133u8, 146u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl PendingFees {
            const METHOD_ID: [u8; 4] = [247u8, 207u8, 241u8, 248u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for PendingFees {
            const NAME: &'static str = "pendingFees";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SafeBatchTransferFrom {
            const METHOD_ID: [u8; 4] = [251u8, 160u8, 238u8, 100u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl SafeTransferFrom {
            const METHOD_ID: [u8; 4] = [15u8, 235u8, 221u8, 73u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetFeesParameters {
            pub u_packed_fee_parameters: [u8; 32usize],
        }
        impl SetFeesParameters {
            const METHOD_ID: [u8; 4] = [84u8, 181u8, 252u8, 135u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetFeesParameters {
            const NAME: &'static str = "setFeesParameters";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SupportsInterface {
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[ethabi::Token::FixedBytes(self.u_interface_id.as_ref().to_vec())],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
        ...
        impl Swap {
            const METHOD_ID: [u8; 4] = [83u8, 192u8, 89u8, 160u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        pub struct TokenX {}
        impl TokenX {
            const METHOD_ID: [u8; 4] = [22u8, 220u8, 22u8, 91u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for TokenX {
            const NAME: &'static str = "tokenX";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for TokenX {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        ...
        pub struct TokenY {}
        impl TokenY {
            const METHOD_ID: [u8; 4] = [183u8, 209u8, 159u8, 196u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for TokenY {
            const NAME: &'static str = "tokenY";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for TokenY {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
    ...
    pub mod events {
        ...
        pub struct Burn {
            ...
            pub amount_x: substreams::scalar::BigInt,
            pub amount_y: substreams::scalar::BigInt,
        }
        impl Burn {
            const TOPIC_ID: [u8; 32] = [
                93u8,
        ...
        pub struct CompositionFee {
            ...
            pub fees_x: substreams::scalar::BigInt,
            pub fees_y: substreams::scalar::BigInt,
        }
        impl CompositionFee {
            const TOPIC_ID: [u8; 32] = [
                86u8,
        ...
        impl substreams_ethereum::Event for CompositionFee {
            const NAME: &'static str = "CompositionFee";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for DepositedToBin {
            const NAME: &'static str = "DepositedToBin";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct OracleSizeIncreased {
            pub previous_size: substreams::scalar::BigInt,
            pub new_size: substreams::scalar::BigInt,
        }
        impl OracleSizeIncreased {
            const TOPIC_ID: [u8; 32] = [
                82u8,
                90u8,
                66u8,
        ...
        impl substreams_ethereum::Event for OracleSizeIncreased {
            const NAME: &'static str = "OracleSizeIncreased";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct Swap {
            ...
            pub volatility_accumulated: substreams::scalar::BigInt,
        ...
        impl substreams_ethereum::Event for WithdrawnFromBin {
            const NAME: &'static str = "WithdrawnFromBin";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
